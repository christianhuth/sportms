	...
	class GameRepository extends SportMSBaseRepository {
		...
		public function findGamesWithHighestLostsForTeam(int $teamUid) {
			...
			$queryBuilder->SELECT('*')
				...
				->ADDORDERBY('result_end_reguler_home', \TYPO3\CMS\Extbase\Persistence\QueryInterface::ORDER_DESCENDING)    # doesn't matter if we use result_end_regular_home or result_end_regular_guest, because both values will be greater for the same difference between different games
				->setMaxResults(10);
