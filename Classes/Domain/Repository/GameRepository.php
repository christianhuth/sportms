	...
	class GameRepository extends SportMSBaseRepository {
		...
		public function findGamesWithHighestLostsForTeam(int $teamUid) {
			...
			$queryBuilder->SELECT('*')
				...
				->ADDORDERBY('GREATEST(' . $tableGameAlias . '.result_end_regular_home, ' . $tableGameAlias . '.result_end_regular_guest)', \TYPO3\CMS\Extbase\Persistence\QueryInterface::ORDER_DESCENDING)
				->setMaxResults(10);
