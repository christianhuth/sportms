...
$GLOBALS['TCA']['tx_clubms_domain_model_game'] = array(
	...
	'columns' => array(
		...
		'game_punishments' => array(
			'label' => 'LLL:EXT:clubms/Resources/Private/Language/locallang_tca.xlf:tx_clubms_domain_model_game.game_punishments',
			'config' => array(
				'appearance' => array(
					'enabledControls' => [
                        'info' => false,
				...
				'foreign_field' => 'game',
				'foreign_table' => 'tx_clubms_domain_model_gamepunishment',
				'type' => 'inline',
			),
		),
		...
		'slug' => [
			...
			'config' => [
				...
				'fallbackCharacter' => '-',
				'generatorOptions' => [
					'fields' => ['uid', 'team_season_home.name', 'team_season_guest.name'],
					'fieldSeparator' => '_',
