        ...
        'competition' => array(
            ...
            'config' => array(
	            ...
	            'foreign_table_where' => '  AND tx_clubms_domain_model_competition.uid IN (SELECT competition FROM tx_clubms_domain_model_competitionseason WHERE season = ###REC_FIELD_season###) 
	                                        ...
	                                        ORDER BY tx_clubms_domain_model_competition.name ASC',
                'items' => Array (
                    array("LLL:EXT:clubms/Resources/Private/Language/locallang_tca.xlf:tx_clubms_general.select", ""),
                ),
                'maxItems' => 1,
            ...
            'config' => array(
	            ...
	            'foreign_table_where' => '  AND tx_clubms_domain_model_team.uid IN 
	                                            (SELECT uid_foreign FROM tx_clubms_competitionseason_teamseason_mm WHERE uid_local = 
	                                                (SELECT uid FROM tx_clubms_competitionseason WHERE competition = ###REC_FIELD_competition### AND season = ###REC_FIELD_season###)
	                                            ) 
