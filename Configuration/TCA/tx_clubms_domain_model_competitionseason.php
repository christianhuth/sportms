			...
			'competition_season_teams' => [
				...
				'config' => [
					...
					'foreign_table_where' => '  AND tx_clubms_domain_model_teamseason.season = ###REC_FIELD_season###
												AND tx_clubms_domain_model_teamseason.team IN (SELECT uid FROM tx_clubms_domain_model_team WHERE section_age_level = (SELECT section_age_level FROM tx_clubms_domain_model_competition WHERE uid = ###THIS_UID###))
												ORDER BY team ASC',
