<?php
    ...
    return [
        'ctrl' => [
            ...
            'iconfile' => 'EXT:sportms/Resources/Public/Icons/tx_sportms_domain_model_urltype.svg',
            'label' => 'label',
            'searchFields' => '',
            'title' => 'LLL:EXT:sportms/Resources/Private/Language/locallang.xlf:tx_sportms_domain_model_urltype',
            'tstamp' => 'tstamp',
            'versioningWS' => true,
        ],
        'types' => [
            '1' => [
                'showitem' => '--div--;LLL:EXT:sportms/Resources/Private/Language/locallang_tca.xlf:tx_sportms_general.tab.general,
										label,
