<?php
	...
	return [
		'ctrl' => [
			...
			'label' => '',
			'label_userFunc' => \Balumedien\Sportms\Classes\UserFunc\UserFunc::class . '->GameChangeLabel',
			'searchFields' => '',
		...
		'columns' => [
			...
			'reason' => [
				...
				'config' => [
					'items' => [
						['LLL:EXT:sportms/Resources/Private/Language/locallang_tca.xlf:tx_sportms_general.select', 0],
						['LLL:EXT:sportms/Resources/Private/Language/locallang_tca.xlf:tx_sportms_domain_model_gamechange.reason.performance', 1],
						['LLL:EXT:sportms/Resources/Private/Language/locallang_tca.xlf:tx_sportms_domain_model_gamechange.reason.tactics', 2],
						['LLL:EXT:sportms/Resources/Private/Language/locallang_tca.xlf:tx_sportms_domain_model_gamechange.reason.injury', 3],
					],
					'renderType' => 'selectSingle',
					'type' => 'select',
				],
