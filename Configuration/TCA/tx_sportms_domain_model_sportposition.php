    ...
    return [
        ...
        'types' => [
            '1' => [
                'showitem' => ' --div--;LLL:EXT:sportms/Resources/Private/Language/locallang_be.xlf:tx_sportms_general.tab.general,
                                ...
                                --div--;LLL:EXT:sportms/Resources/Private/Language/locallang_be.xlf:tx_sportms_domain_model_sportposition.tab_representation,
                                    --palette--;;positions,
        ...
        'columns' => [
            ...
            'sport_position_group' => [
                'exclude' => 1,
                'label' => 'LLL:EXT:sportms/Resources/Private/Language/locallang_be.xlf:tx_sportms_domain_model_sportpositiongroup',
                'config' => [
                    'eval' => 'required',
            ...
            'x_position' => [
                'exclude' => 1,
                'label' => 'LLL:EXT:sportms/Resources/Private/Language/locallang_be.xlf:tx_sportms_domain_model_sportposition.x_position',
                'config' => [
                    'type' => 'input',
                    'size' => 30,
                    'eval' => 'alphanum, trim',
            ...
            'y_position' => [
                'exclude' => 1,
                'label' => 'LLL:EXT:sportms/Resources/Private/Language/locallang_be.xlf:tx_sportms_domain_model_sportposition.y_position',
                'config' => [
                    'type' => 'input',
                    'size' => 30,
                    'eval' => 'alphanum, trim',
