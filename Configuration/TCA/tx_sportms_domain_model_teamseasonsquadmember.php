<?php
	...
	return [
		'ctrl' => [
			...
			'label' => '',
			'label_userFunc' => \Balumedien\Sportms\Classes\UserFunc\UserFunc::class . '->TeamSeasonSquadMemberLabel',
			'searchFields' => '',
			'sortby' => 'sorting',
		...
		'types' => [
			'1' => ['showitem' => 'person, sport_position_group, sport_position, squad_number,
									...
									--div--;LLL:EXT:sportms/Resources/Private/Language/locallang_tca.xlf:tx_sportms_general.tab.visibility, hidden, hidden_in_squad_list,
		                            '],
		],
		'palettes' => [
			'1' => ['showitem' => ''],
