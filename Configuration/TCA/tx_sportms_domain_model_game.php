	...
	return [
		...
		'columns' => [
			...
			'game_appointment' => [
				...
				'config' => [
					'items' => [
						['LLL:EXT:sportms/Resources/Private/Language/locallang_tca.xlf:tx_sportms_domain_model_game.game_appointment.planned', 1],
						['LLL:EXT:sportms/Resources/Private/Language/locallang_tca.xlf:tx_sportms_domain_model_game.game_appointment.canceled', 2],
						['LLL:EXT:sportms/Resources/Private/Language/locallang_tca.xlf:tx_sportms_domain_model_game.game_appointment.dropped', 3],
						['LLL:EXT:sportms/Resources/Private/Language/locallang_tca.xlf:tx_sportms_domain_model_game.game_appointment.running', 4],
						['LLL:EXT:sportms/Resources/Private/Language/locallang_tca.xlf:tx_sportms_domain_model_game.game_appointment.uncompleted', 5],
						['LLL:EXT:sportms/Resources/Private/Language/locallang_tca.xlf:tx_sportms_domain_model_game.game_appointment.finished', 6],
					],
					'renderType' => 'selectSingle',
					'type' => 'select',
				],
			...
			'game_rating' => [
				'config' => [
					'items' => [
						['LLL:EXT:sportms/Resources/Private/Language/locallang_tca.xlf:tx_sportms_domain_model_game.game_rating.normal', 1],
						['LLL:EXT:sportms/Resources/Private/Language/locallang_tca.xlf:tx_sportms_domain_model_game.game_rating.special', 2],
						['LLL:EXT:sportms/Resources/Private/Language/locallang_tca.xlf:tx_sportms_domain_model_game.game_rating.invalid', 3],
					],
					'renderType' => 'selectSingle',
					'type' => 'select',
				],
			...
			'result_special_reason' => [
				'config' => [
					'items' => [
						...
						['LLL:EXT:sportms/Resources/Private/Language/locallang_tca.xlf:tx_sportms_domain_model_game.result_special_reason.1', 1],
						['LLL:EXT:sportms/Resources/Private/Language/locallang_tca.xlf:tx_sportms_domain_model_game.result_special_reason.2', 2],
						['LLL:EXT:sportms/Resources/Private/Language/locallang_tca.xlf:tx_sportms_domain_model_game.result_special_reason.3', 3],
						['LLL:EXT:sportms/Resources/Private/Language/locallang_tca.xlf:tx_sportms_domain_model_game.result_special_reason.4', 4],
					],
					'renderType' => 'selectSingle',
					'type' => 'select',
				],
				...
				'exclude' => TRUE,
				'label' => 'LLL:EXT:sportms/Resources/Private/Language/locallang_tca.xlf:tx_sportms_domain_model_game.result_special_reason',
			],
			...
			'result_type' => [
				...
				'config' => [
					...
					'eval' => 'required',
					'items' => [
						['LLL:EXT:sportms/Resources/Private/Language/locallang_tca.xlf:tx_sportms_domain_model_game.result_type_halfs', 2],
						['LLL:EXT:sportms/Resources/Private/Language/locallang_tca.xlf:tx_sportms_domain_model_game.result_type_thirds', 3],
						['LLL:EXT:sportms/Resources/Private/Language/locallang_tca.xlf:tx_sportms_domain_model_game.result_type_quarters', 4],
						['LLL:EXT:sportms/Resources/Private/Language/locallang_tca.xlf:tx_sportms_domain_model_game.result_type_sets', -10],
					],
					'renderType' => 'selectSingle',
					'type' => 'select',
				],
