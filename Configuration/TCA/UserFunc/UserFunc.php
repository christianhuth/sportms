<?php
	...
	class UserFunc {
		...
		public function clubOfficialLabel(&$parameters, $parentObject): void {
			...
			$officialJob = BackendUtility::getRecord('tx_sportms_domain_model_clubofficialjob', $record['club_official_job']);
		...
		public function clubSectionOfficialLabel(&$parameters, $parentObject): void {
			$record = BackendUtility::getRecord($parameters['table'], $parameters['row']['uid']);
			$person = BackendUtility::getRecord('tx_sportms_domain_model_person', $record['person']);
			$officialJob = BackendUtility::getRecord('tx_sportms_domain_model_clubsectionofficialjob', $record['club_section_official_job']);
		...
		public function competitionLabel(&$parameters, $parentObject): void {
			...
			$sportAgeLevel = BackendUtility::getRecord('tx_sportms_domain_model_sportagelevel', $record['sport_age_level']);
		...
		public function gameLabel(&$parameters, $parentObject): void {
			$record = BackendUtility::getRecord($parameters['table'], $parameters['row']['uid']);
			$competitionSeason = BackendUtility::getRecord('tx_sportms_domain_model_competitionseason', $record['competition_season']);
			$competition = BackendUtility::getRecord('tx_sportms_domain_model_competition', $competitionSeason['competition']);
			$season = BackendUtility::getRecord('tx_sportms_domain_model_season', $competitionSeason['season']);
			$teamSeasonHome = BackendUtility::getRecord('tx_sportms_domain_model_teamseason', $record['team_season_home']);
			$teamHome = BackendUtility::getRecord('tx_sportms_domain_model_team', $teamSeasonHome['team']);
			$teamSeasonGuest = BackendUtility::getRecord('tx_sportms_domain_model_teamseason', $record['team_season_guest']);
		...
		public function gameLineupLabel(&$parameters, $parentObject): void {
			...
			if($record['sport_position']) {
				$sportPosition = BackendUtility::getRecord('tx_sportms_domain_model_sportposition', $record['sport_position']);
		...
		public function teamSeasonOfficialLabel(&$parameters, $parentObject): void {
			$record = BackendUtility::getRecord($parameters['table'], $parameters['row']['uid']);
			$person = BackendUtility::getRecord('tx_sportms_domain_model_person', $record['person']);
			$officialJob = BackendUtility::getRecord('tx_sportms_domain_model_teamseasonofficialjob', $record['team_season_official_job']);
		...
		public function teamSeasonPracticeLabel(&$parameters, $parentObject): void {
			$record = BackendUtility::getRecord($parameters['table'], $parameters['row']['uid']);
			$newLabel = LocalizationUtility::translate('tx_sportms_general.day.' . $record['day'], 'sportms') . ' (' . substr($record['time_start'], 0, 5) . ' - ' . substr($record['time_end'], 0, 5) . ' ' . LocalizationUtility::translate('tx_sportms_general.clock', 'sportms') . ')';
			$parameters['title'] = $newLabel;
		}
		...
		public function teamSeasonSquadMemberLabel(&$parameters, $parentObject): void {
			...
			if($record['sport_position_group']) {
				$sportPositionGroup = BackendUtility::getRecord('tx_sportms_domain_model_sportpositiongroup', $record['sport_position_group']);
