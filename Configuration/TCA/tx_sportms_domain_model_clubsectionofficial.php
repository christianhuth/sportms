	...
	'columns' => array(
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_sportms_domain_model_clubsectionofficial}.{#pid}=###CURRENT_PID### AND {#tx_sportms_domain_model_clubsectionofficial}.{#sys_language_uid} IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
