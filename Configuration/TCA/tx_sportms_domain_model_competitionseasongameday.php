<?php
    ...
    return [
        ...
        'types' => [
            '1' => [
                'showitem' => ' --div--;LLL:EXT:sportms/Resources/Private/Language/locallang_be.xlf:tx_sportms_general.tab.general,
                                    competition_season,
                                    label,
                                    --palette--;LLL:EXT:sportms/Resources/Private/Language/locallang_be.xlf:tx_sportms_domain_model_competitionseasongameday.palette_startdate_enddate;startdate_enddate,
        ...
        'columns' => [
            ...
            'competition_season' => [
                'exclude' => 1,
                'label' => 'LLL:EXT:sportms/Resources/Private/Language/locallang_be.xlf:tx_sportms_domain_model_competitionseasongameday.competition_season',
                'config' => [
                    'eval' => 'required',
